...
begin
  ...
  if AIndex >= ListBox.Count then Exit;
...
begin
  do_SelectListBox( FAnimationIndex );

  FAnimationIndex := FAnimationIndex + 1;
  if FAnimationIndex >= ListBox.Items.Count then FAnimationIndex := 0;
