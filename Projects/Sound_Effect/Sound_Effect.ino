...
void seCloseEncounters(int pinNo) {
	beep(pinNo, note_Bb5, 300); // B b
	delay(50);
	beep(pinNo, note_C6, 300); // C
	delay(50);
	beep(pinNo, note_Ab5, 300); // A b
	delay(50);
	beep(pinNo, note_Ab4, 300); // A b
	delay(50);
	beep(pinNo, note_Eb5, 500); // E b
	delay(500);
	beep(pinNo, note_Bb4, 300); // B b
	delay(100);
	beep(pinNo, note_C5, 300); // C
	delay(100);
	beep(pinNo, note_Ab4, 300); // A b
	delay(100);
	beep(pinNo, note_Ab3, 300); // A b
	delay(100);
	beep(pinNo, note_Eb4, 500); // E b
	delay(500);
	beep(pinNo, note_Bb3, 300); // B b
	delay(200);
	beep(pinNo, note_C4, 300); // C
	delay(200);
	beep(pinNo, note_Ab3, 300); // A b
	delay(500);
	beep(pinNo, note_Ab2, 300); // A b
	delay(550);
	beep(pinNo, note_Eb3, 500); // E b
}

void seAriel(int pinNo) {
	beep(pinNo, note_C6, 300); // C
	delay(50);
	beep(pinNo, note_D6, 300); // D
	delay(50);
	beep(pinNo, note_Eb6, 600); // D#
	delay(250);

	beep(pinNo, note_D6, 300); // D
	delay(50);
	beep(pinNo, note_Eb6, 300); // D#
	delay(50);
	beep(pinNo, note_F6, 600); // F
	delay(250);
...
void seLaugh2(int pinNo) {
	beep(pinNo, note_C6, 200); // C
	beep(pinNo, note_E6, 200); // E
	beep(pinNo, note_G6, 200); // G
	beep(pinNo, note_C7, 200); // C
	beep(pinNo, note_C6, 200); // C
	delay(50);
	beep(pinNo, note_C6, 200); // C
	beep(pinNo, note_E6, 200); // E
...
void seMaschinengewehr(int pinNo) {
	int i;
